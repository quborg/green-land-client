...
export const compare2arrays = (a: Array<string>, o: any): boolean => {
  const b = Object.keys(o).filter((title) => o[title]);
  return a.length === b.length && !a.filter((e) => !b.includes(e)).length;
};
